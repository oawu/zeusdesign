...
class Articles extends Site_controller {
  ...
  public function show ($id = 0) {
    ...
    $this
         ...
         ->add_meta (array ('name' => 'lastmod', 'property' => 'article:modified_time', 'content' => $article->updated_at->format ('c')))
         ->add_meta (array ('name' => 'pubdate', 'property' => 'article:published_time', 'content' => $article->created_at->format ('c')))
         ->add_meta (array ('name' => 'section', 'property' => 'article:section', 'content' => $article->tags ? $article->tags[0]->name : '宙思設計'))
         ->add_meta (array ('name' => 'tags', 'property' => 'article:tag', 'content' => $article->tags ? implode(',', column_array ($article->tags, 'name')) : '網頁設計,宙思,設計'))
