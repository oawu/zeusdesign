<form action='<?php echo base_url (array ('admin', 'article_tags', $tag->id));?>' method='post' enctype='multipart/form-data'>
  ...
  <table class='table-form'>
    <tbody>
      ...
      <tr>
        <td colspan='2'>
          <a href='<?php echo base_url ('admin', 'article_tags');?>'>回列表</a>
