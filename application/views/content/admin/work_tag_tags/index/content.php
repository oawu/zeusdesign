<form action='<?php echo base_url ('admin', 'work_tags', $parent_tag->id, 'tags');?>' method='get' class="search<?php echo $has_search = array_filter (column_array ($columns, 'value')) ? ' show' : '';?>">
<?php 
  if ($columns) { ?>
