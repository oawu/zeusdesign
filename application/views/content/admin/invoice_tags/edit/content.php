<form action='<?php echo base_url (array ('admin', 'invoice_tags', $tag->id));?>' method='post' enctype='multipart/form-data'>
  ...
  <table class='table-form'>
    <tbody>
      ...
      <tr>
        <td colspan='2'>
          <a href='<?php echo base_url ('admin', 'invoice_tags');?>'>回列表</a>
