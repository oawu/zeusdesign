...
$menu['admin'] = array (
    '管理後台' => array (
        ...
        '訪客留言' => array ('roles' => array ('contact_manager'), 'icon' => 'icon-comment', 'href' => base_url ('admin', 'contacts'), 'class' => 'contacts', 'method' => '', 'target' => '_self'),
        '使用者設定' => array ('roles' => array ('user_manager'), 'icon' => 'icon-user2', 'href' => base_url ('admin', 'users'), 'class' => 'users', 'method' => '', 'target' => '_self'),
      ),
    '部落格' => array (
    ...
    '官網上搞' => array (
        '作品分類' => array ('roles' => array ('official_editor'), 'icon' => 'icon-tags', 'href' => base_url ('admin', 'work_tags'), 'class' => 'work_tags', 'method' => '', 'target' => '_self'),
          '子分類' => array ('roles' => array ('official_editor'), 'icon' => 'icon-tags', 'href' => base_url ('admin', 'work_tags'), 'class' => 'work_tag_tags', 'method' => '', 'target' => '_self', 'no_show' => true),
        '作品管理' => array ('roles' => array ('official_editor'), 'icon' => 'icon-images', 'href' => base_url ('admin', 'works'), 'class' => 'works', 'method' => '', 'target' => '_self'),
        'Banner管理' => array ('roles' => array ('official_editor'), 'icon' => 'icon-images', 'href' => base_url ('admin', 'banners'), 'class' => 'banners', 'method' => '', 'target' => '_self'),
        'Promo管理' => array ('roles' => array ('official_editor'), 'icon' => 'icon-images', 'href' => base_url ('admin', 'promos'), 'class' => 'promos', 'method' => '', 'target' => '_self'),
      ),
    '帳務' => array (
